...
import { AddEditViewUserPopupComponent } from '../addEditViewUserPopup/addEditViewUser-popup.component';
...
export class UsersComponent {
  ...
  onAddEditUsers(user?: User, text?: any) {
    let data = { user, text };
    const dialogref = this._dialogService.open(AddEditViewUserPopupComponent, {
      header:
        user && !text
